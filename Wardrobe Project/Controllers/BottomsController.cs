...
namespace Wardrobe_Project.Controllers
{
    public class BottomsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BottomID,Description,Photo,Color,Season,Occasion")] Bottom bottom)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BottomID,Description,Photo,Color,Season,Occasion")] Bottom bottom)
        {
            if (ModelState.IsValid)
            {
